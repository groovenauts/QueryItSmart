...
/***/ function(module, exports, __webpack_require__) {
	...
	var THUMBNAIL_SIZE = exports.THUMBNAIL_SIZE = 60,
	    ...
	    CHANNEL_IMAGES = exports.CHANNEL_IMAGES = [{ id: "image", name: "Wikimedia Images", src: './images/image.jpg', className: CONTENT_CLASSES[0] }, { id: "text", name: "Stack Overflow Questions", src: './images/text.jpg', className: CONTENT_CLASSES[1] }, { id: "map", name: "NYC City Bike Usage Forecast", src: './images/map.jpg', className: CONTENT_CLASSES[2] }],
...
/***/ function(module, exports) {
	...
	module.exports = {
		...
		"searchImage": {
			...
			"analyzing": {
				"title": "Searching...",
				"subtitle": "On 1 million Wikimedia images with BigQuery. Elapsed ${time} sec"
			},
			"analyzed": {
				"title": "Finished!",
